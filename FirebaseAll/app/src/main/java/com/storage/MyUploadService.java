...
/**
 * Created by prashant.patel on 4/24/2017.
 */
...
import static com.storage.StorageMainActivity.strFirebaseFolder;
...
public class MyUploadService extends MyBaseTaskService {
    ...
    private void uploadFromUri(final Uri fileUri) {
        ...
        final StorageReference photoRef = mStorageRef.child(strFirebaseFolder)
    ...
    private void showUploadFinishedNotification(@Nullable Uri downloadUrl, @Nullable Uri fileUri) {
        ...
        // Make Intent to StorageMainActivity
