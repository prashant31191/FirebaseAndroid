...
public class StorageMainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String TAG = "Storage#StorageMainActivity";
    ...
    public static String strFirebaseFolder = "images";
    ...
    private void beginDownload() {
        // Get path
        String path = strFirebaseFolder+"/" + mFileUri.getLastPathSegment();
