...
public class AnonymousAuthActivity extends BaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Click listeners
        Button button_anonymous_sign_in = (Button) findViewById(R.id.button_anonymous_sign_in);
        Button button_anonymous_sign_out = (Button) findViewById(R.id.button_anonymous_sign_out);
        Button button_link_account = (Button) findViewById(R.id.button_link_account);
